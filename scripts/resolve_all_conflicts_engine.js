...
function getConflicts(lessons, classes, subjects, teachers, shifts) {
...
async function main() {
  ...
  console.log('Initial conflict count:', getConflicts(lessons, classes, subjects, teachers, shifts).length);
